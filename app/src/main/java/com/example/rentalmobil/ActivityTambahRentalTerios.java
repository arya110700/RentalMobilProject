...
public class ActivityTambahRentalTerios extends Activity implements ViewStub.OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.add_record:
                ...
                else
                {
                    ...
                    Intent main = new Intent(ActivityTambahRentalTerios.this, ActivityDataRental.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(main);
