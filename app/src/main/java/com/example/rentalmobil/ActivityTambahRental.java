...
public class ActivityTambahRental extends Activity implements ViewStub.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addrental_activity);
        ...
        switch (v.getId()) {
            case R.id.add_record:
                ...
                else
                {
                    ...
                    Intent main = new Intent(ActivityTambahRental.this, ActivityDataRental.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(main);
